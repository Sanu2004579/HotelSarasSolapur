...
// ── Reset the reservation form after successful order ─────────
function resetForm() {
  const form = document.querySelector('form.form-left');
  if (form) form.reset();
  selectedItems      = {};
  currentBookingData = {};
  window._sarasPayItems = null;
  window._sarasPayTotal = null;
}

// ═══════════════════════════════════════════════════════════════
//  DOM Ready — wire up reservation form + newsletter
// ═══════════════════════════════════════════════════════════════
